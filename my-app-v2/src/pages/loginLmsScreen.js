...
export default function LoginLmsScreen({ navigation }) {
    ...
    >
      <Animated.View style={[styles.wrapper, { opacity: fadeAnim }]}>
        <ScrollView contentContainerStyle={styles.wrapper}>
          <Animated.Text
            style={[styles.largeLetter, { transform: [{ scale: scaleAnim }] }]}
          >
            <Text variant="displayLarge" style={styles.uniqueM}>
              LMS
            </Text>
          </Animated.Text>
          <Animated.Text
          ...
          >
            <Text variant="headlineMedium" style={styles.titlelog}>
              Login
            </Text>
          </Animated.Text>
          ...
          <Card.Content style={styles.cardContent}>
            ...
            <View style={{ paddingTop: 20 }}>
              <Text style={styles.loginText} onPress={() => navigation.navigate("ForgotPasswordLms")}>Forgot Password?</Text>
            </View>
          </Card.Content>
        </ScrollView>
      </Animated.View>
