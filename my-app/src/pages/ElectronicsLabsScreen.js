...
const ElectronicsLabsScreen = ({ route }) => {
  const { item } = route.params;
  const navigation = useNavigation();

  const games = [
    { name: "Game1", title: "Electronics Labs 1", icon: "resistor" },
    { name: "Game2", title: "Electronics Labs 2", icon: "resistor" },
  ];
...
export default ElectronicsLabsScreen;
